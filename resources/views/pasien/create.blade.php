  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm ">
    ...
    <div class="col-12 col-md-7 mb-5">
      ...
      <div class="mb-3 row">
          ...
          <div class="col-sm-10">
              <input type="number" class="form-control" name='usia' value="{{ Session::get ('usia') }}" id="usia">
          </div>
      </div>
      <div class="mb-3 row">
          <label for="jk" class="col-sm-2 col-form-label">Jenis Kelamin</label>
          <div class="col-sm-10">
            <select name="jk" id="jk" class="form-control" value="{{ Session::get ('jk') }}">
      ...
      <div class="mb-3 row">
          ...
          <div class="col-sm-10">
              <input type="text" class="form-control" name='riwayat' value="{{ Session::get ('riwayat') }}" id="riwayat">
          </div>
      </div>
      <div class="mb-3 row">
        <label for="poli" class="col-sm-2 col-form-label">Poli</label>
        <div class="col-sm-10">
          <select name="poli" id="poli" class="form-control" value="{{ Session::get ('value') }}">
            <option value="pilih salah satu"></option>
